...
export const metadata: Metadata = {
  title: 'Documentário',
  description: 'Documentários jornalísticos do SONDA MÍDIA.',
}
      ...
      <div style={{ background: 'var(--carvao)', borderBottom: '1px solid var(--cinza-3)', padding: '40px 0' }}>
        <div className="container">
          <div className="section-head">
            ...
            <span className="section-head__title">Audiovisual</span>
          </div>
          ...
          <p style={{ fontSize: '0.95rem', color: 'var(--cinza)', maxWidth: '540px' }}>
            Produções audiovisuais que aprofundam temas que o jornalismo diário não consegue alcançar.
          </p>
        </div>
      </div>
      ...
      <div className="container" style={{ padding: '48px 24px' }}>
        {articles.length === 0 ? (
          <p style={{ color: 'var(--cinza)', textAlign: 'center', padding: '80px 0', fontSize: '1rem' }}>
            Nenhum documentário publicado ainda.
          </p>
        ) : (
          <>
            {hero && (
